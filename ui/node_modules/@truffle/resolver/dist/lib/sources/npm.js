...
class NPM {
    ...
    require(importPath, searchPath) {
        ...
        for (const basePath of [searchPath, this.workingDirectory]) {
            ...
            const expectedPath = path_1.default.join(basePath, "node_modules", packageName, "build", "contracts", contractName + ".json");
            try {
                const result = fs_1.default.readFileSync(expectedPath, "utf8");
    ...
    resolveDependencyPath(import_path, dependency_path) {
